...
typedef std::unique_ptr<RasterDBBackend> (*BackendConstructor)(const std::string &location, const std::shared_ptr<cpptoml::table> params);
...
std::unique_ptr<RasterDBBackend> RasterDBBackend::create(const std::string &backend, const std::string &location, const std::shared_ptr<cpptoml::table> params) {
	auto map = getRegisteredConstructorsMap();
