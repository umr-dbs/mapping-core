...
class CrsId {
    public:
        ...
        /**
         * Create a Web Mercator CrsId
         */
        static CrsId web_mercator();

        /**
         * Create a WGS 84 CrsId
         */
        static CrsId wgs84();
...
class GridSpatioTemporalResult : public SpatioTemporalResult {
    public:
        ...
        GridSpatioTemporalResult(const SpatioTemporalReference &stref, uint32_t width, uint32_t height)
                : SpatioTemporalResult(stref), width(width), height(height),
                  pixel_scale_x((stref.x2 - stref.x1) / width), pixel_scale_y((stref.y2 - stref.y1) / height) {
        };
