...
#include "operators/processing/meteosat/msg_constants.h"
...
class MeteosatTemperatureOperator : public GenericOperator {
	public:
		MeteosatTemperatureOperator(int sourcecounts[], GenericOperator *sources[], Json::Value &params);
...
MeteosatTemperatureOperator::MeteosatTemperatureOperator(int sourcecounts[], GenericOperator *sources[], Json::Value &params) : GenericOperator(sourcecounts, sources) {
	assumeSources(1);

	forceSatellite = params.get("forceSatellite", "").asString();
}
MeteosatTemperatureOperator::~MeteosatTemperatureOperator() {
}
REGISTER_OPERATOR(MeteosatTemperatureOperator, "meteosat_temperature");

void MeteosatTemperatureOperator::writeSemanticParameters(std::ostringstream& stream) {
...
#include "operators/processing/meteosat/temperature.cl.h"
